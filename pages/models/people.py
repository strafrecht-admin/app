...
class People(models.Model):
    ...
    ROLE_CHOICES = [
        ...
        ('former academic-staff-female', 'Ehem. Wiss. Mitarbeiterin'),
        ('academic-assistant', 'Wiss. Hilfskraft'),
        ('student-assistant', 'Stud. Hilfskraft'),
        ('jurcoach-law-team-academic', 'Wiss. Hilfskraft Jurcoach'), 
        ('jurcoach-law-team-student', 'Stud. Hilfskraft Jurcoach'),
